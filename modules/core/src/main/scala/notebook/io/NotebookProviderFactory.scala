...
object NotebookProviderFactory extends Logging {
  ...
  def createNotebookIoProvider(providerConfiguratorClass: String, providerConfig: Config, initTimeoutMillis: Long)(implicit ec: ExecutionContext): NotebookProvider = {
